...
<div class="box">
  <div class="box box--right">
    ...
    <div class="box__description">
        ...
        SELECT * from uzytkownicy where ID_uzytkownicy='${ktory}'
        </sql:query>
        
        <form method="post" action="modyfikuj_uczniowie_2.jsp">
            <c:forEach var="wiersz" items="${wynik.rows}">
            <label>Imię</label>
            <input type="text" name="imie" value="${wiersz.imie}" required><br><br>
            <label>Nazwisko</label>
            <input type="text" name="nazwisko" value="${wiersz.nazwisko}" required><br><br>
            <label>Login</label>
            <input type="text" name="login" value="${wiersz.login}" required><br><br>
            <label>Haslo</label>
            <input type="password" name="haslo" value="${wiersz.password}" required><br><br>
            <input type="hidden" name="edytuj_ktory" value="${wiersz.ID_uzytkownicy}" /><br><br><br>
            </c:forEach>
