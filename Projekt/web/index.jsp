...
<html>
    <head>
        ...
        <title><c:out value="${sessionScope['loginUser']}" /></title>
...
<div class="box">
  <div class="box box--right">
    ...
    <div class="box__description">
            ...
            <c:if test="${empty sessionScope['loginUser']}"><h2>Zaloguj się!</h2><img src="de.png"  alt="Smiley face"></c:if>
        
            <c:if test="${not empty sessionScope['loginUser']}"><h2>Witaj <c:out value="${sessionScope['loginUser']}" />.</h2><img src="de.png" alt="Smiley face" ></c:if>
    </body>
</html>
