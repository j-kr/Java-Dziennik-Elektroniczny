    ...
    <div class="box__description">
        ...
        <c:if test="${pageContext.request.method=='POST'}">
            ...
            <c:when test="${param.przedmiot == wybrany_przedmiot}">
                ...
                SELECT * from oceny JOIN uczniowie ON oceny.ID_uczniowie = uczniowie.ID_uczniowie JOIN przedmioty ON oceny.ID_przedmioty = przedmioty.ID_przedmioty WHERE Nazwa = ?;
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><form method="post" action="modyfikuj_oceny.jsp"><input type="hidden" name="edytuj_ktory" value="${wiersz.ID_oceny}" /><button name="edytuj">Modyfikuj</button></form></td>
                        <td><form method="post" action="usun_oceny.jsp"><input type="hidden" name="usun_ktory" value="${wiersz.ID_oceny}" /><button name="edytuj">Usun</button></form></td>
                    </tr>
                    </c:forEach>
