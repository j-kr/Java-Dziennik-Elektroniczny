    ...
    <div class="box__description">
        ...
        <c:forEach var="wiersz" items="${wynik.rows}">
            <tr>
                ...
                <td><form method="post"><input type="hidden" name="usun_ktory" value="${wiersz.ID_przedmioty}" /><button name="usun">Usuń</button></form></td> 
            </tr>
        </c:forEach>
        ...
        <c:if test="${pageContext.request.method=='POST'}">
            ...
            <sql:update dataSource="${Polaczenie}" var="usun">
                DELETE from przedmioty where ID_przedmioty='${ktory}'
            </sql:update>
