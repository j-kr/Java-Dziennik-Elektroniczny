...
<div class="box">
  <div class="box box--right">
    ...
    <div class="box__description">
        ...
        SELECT * from oceny where ID_oceny='${ktory}'
        </sql:query>
        
        <form method="post" action="modyfikuj_oceny_2.jsp">
            <c:forEach var="wiersz" items="${wynik.rows}">
            <label>Ocena</label>
            <input type="number" name="ocena" value="${wiersz.ocena}" required><br>
            <label>Opis</label>
            <input type="text" name="opis" value="${wiersz.opis}" required><br>
            <input type="hidden" name="edytuj_ktory" value="${wiersz.ID_oceny}" /><br><br>
            </c:forEach>
